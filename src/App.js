...
import { useReactTable, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, getGroupedRowModel } from '@tanstack/react-table';
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TableSortLabel, TablePagination, Button, TextField } from '@mui/material';
import { ArrowDownward, ArrowUpward, FilterList } from '@mui/icons-material';
import { format, parseISO } from 'date-fns';

// Sample Data Fetching Function (could be replaced with an API call)
    ...
    <TableContainer>
      <div style={{ padding: '16px', display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Button
          ...
          onClick={() => console.log('Filter options panel')}
        >
          Filter
        </Button>
      </div>
              ...
              {headerGroup.headers.map(header => (
                <TableCell key={header.id}>
                  ...
                  >
                    ...
                    {header.column.getIsSorted() === 'desc' ? <ArrowDownward /> : <ArrowUpward />}
                  </TableSortLabel>
                </TableCell>
              ))}
            </TableRow>
